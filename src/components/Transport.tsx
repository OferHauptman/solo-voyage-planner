  ...
  return (
    <div className="max-w-2xl mx-auto p-4 pb-24">
      <div className="text-center mb-6">
        <h1 className="text-2xl font-bold text-travel-navy mb-2">Travel & Transport</h1>
        <p className="text-gray-600">Your journey connections and accommodations</p>
      </div>
      ...
      {/* Travel Tips */}
      <div className="bg-gradient-to-r from-travel-blue to-travel-navy rounded-lg p-6 text-white">
